...
def _get_gemini_model():
    ...
    if _gemini_model is None:
        try:
            ...
            _gemini_model = genai.GenerativeModel('gemini-1.5-flash') # Daha hızlı ve güncel
        except Exception as e:
...
def ai_analist_yorumu(sembol: str, temel: dict, teknik: dict) -> str:
    ...
    return asyncio.run(ai_analiz_uret(sistem, kullanici))
